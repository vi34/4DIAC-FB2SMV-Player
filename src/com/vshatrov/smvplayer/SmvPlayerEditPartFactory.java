...
import org.eclipse.fordiac.ide.fbtypeeditor.network.viewer.ConnectionEditPartRO;
import org.eclipse.fordiac.ide.fbtypeeditor.network.viewer.FBEditPartRO;
 ...
 */
class SmvPlayerEditPartFactory extends CompositeNetworkEditPartFactory {
	...
	private EditPart getPartInternal(EditPart context, Object modelElement) {
		...
		if (modelElement instanceof FB) {
			return new FBEditPart(zoomManager); // todo: make Read-only
		}
